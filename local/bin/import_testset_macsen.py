...
MACSEN_TESTSET_TARFILE = "macsen_v1.2.tar.gz"
...
def main(testset_root_dir, csv_file, alphabet_file_path, **args):
    ...
    csv_file_out = csv.DictWriter(open(csv_file, 'w', encoding='utf-8'), fieldnames=moz_fieldnames)
    ...
    for top in macsen_files:
        for recs in macsen_files[top]:
            recs_file_path=os.path.join(testset_root_dir, recs)
